...
fig_anim, ax1, ax2, ax3, beads_xy, beads_yz, beads_xz, time_template, time_string = anim_setup()
...
fig_ex, ax1, ax2, ax3, beads_xy, beads_yz, beads_xz, time_template, time_string = anim_setup()
