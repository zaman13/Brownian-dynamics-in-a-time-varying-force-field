...
def geo_points4():
    ...
    p_wall = [          [  [-250,120], [250,120], [250,150], [-250,150]       ],
                        [  [-250,-120], [250,-120], [250,-150], [-250,-150]   ],
                        [  [200,-30],[220,-30], [220,30],[200,30]             ],
              ]
...
def geo_points3():
    ...
    #    [                                     ]     # .... (so on)
    #  ]
    p_wall   = [        [  [190,30], [350,30], [350,77]         ],
                        [  [190,-30], [350,-30], [350,-77]      ],
...
def geo_points5():
    ...
    p_wall = [      [  [-250,120], [175,120], [350,170], [350,200], [-250,200]       ],
                    [  [-250,-120], [175,-120], [350,-170], [350,-200], [-250,-200]  ],
