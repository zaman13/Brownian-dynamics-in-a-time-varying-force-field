...
$m \frac{\partial\mathbf{v}(\mathbf{r},t)}{\partial t} = \frac{k_B T}{\overset{\leftrightarrow}{\mathbf{D}}(\mathbf{r})} \Bigg[\mathbf{v}_f(\mathbf{r},t)-\mathbf{v}(\mathbf{r},t) + \sqrt{2} \overset{\leftrightarrow}{\mathbf{D} _{1/2}}(\mathbf{r}) \mathbf{W}(t) \Bigg] + \mathbf{F}_e(\mathbf{r},t)$
